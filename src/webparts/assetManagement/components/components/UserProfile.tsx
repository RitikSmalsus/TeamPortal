          ...
          <tbody>
            {platformAccounts.map(account => (
              <tr key={account.id}>
                ...
                <td><span className={` ${account.status === AccountStatus.ACTIVE ? 'text-bg-success' : 'text-bg-danger'}`}>{account.status}</span></td>
                ...
                <tbody className="small">
                  {user.history?.map(item => (
                    <tr key={item.id}>
                      ...
                      <td><span className={`${item.type === 'Assigned' ? 'text-bg-success' : 'text-bg-danger'}`}>{item.type}</span></td>
